...
<body>
        ...
        <div class="topbar-section" style="background-color: #1683b3;background-image: url('images/footer.png');border-top: 4px dashed #fff;">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 hidden-xs-down">
                        <div class="topsocial">
                            ...
                            <a href="#" data-toggle="tooltip" data-placement="bottom" title="Google+"><i class="fa fa-google-plus" style="color: #fff;"></i></a>
                        </div><!-- end social -->
                    </div><!-- end col -->
                    ...
                    <div class="col-lg-6 hidden-md-down">
                        <div class="topmenu text-center" >
                            <ul class="list-inline">
                                <li class="list-inline-item"><a  href="blog-category-01.html"><i style="color: #fff;" class="fa fa-envelope-o"></i> <strong style="color: #fff;"> Email: info@satina-holding.com</strong></a></li>
                                <li class="list-inline-item"><a href="blog-category-02.html"><i style="color: #fff;" class="fa fa-phone"></i> <strong style="color: #fff;">628 44 95 77/624 20 20 99</strong></a></li>
                            </ul><!-- end ul -->
                        </div><!-- end topmenu -->
                    </div><!-- end col -->
